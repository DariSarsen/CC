...
const Home = () => {
    return (
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-red-900 bg-opacity-20 backdrop-blur-sm px-6 py-5 flex items-center justify-between">
      {/* Logo */}
      ...
      <div className="relative min-h-screen bg-cover bg-center bg-no-repeat bg-[url('/images/alumni.png')] place-content-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center text-white">
          ...
          <h2 className="font-italianno text-7xl mb-4 animate-fadeInUp delay-100">Narxoz Alumni</h2>

          <h1 className="text-6xl tracking-widest mb-6 animate-fadeInUp delay-200 font-semibold">
            Бар керегің — осында. <br />
            Бір-біріңді де табасың.
          </h1>

          <p className="text-xl max-w-2xl animate-fadeInUp delay-300 tracking-wide font-normal">
      ...
      <div className=" bg-gradient-to-b from-red-900 to-red-950 ">

        <div className="flex flex-col items-center justify-center text-center text-white px-4 py-20">

          {/* Заголовок с кастомным шрифтом */}
          <p className="text-7xl font-italianno animate-fadeInUp delay-500 my-16">
            Narxoz — Stay Connected, Wherever You Are
          </p>

          {/* Контейнер с изображением и текстом */}
          <div className="flex flex-row items-center justify-center w-full max-w-7xl gap-x-16 px-4 animate-fadeInUp delay-600 mb-16">
            ...
            <div className="text-left max-w-2xl">
              <p className="text-4xl font-semibold mb-4 animate-fadeInUp delay-200">
                Narxoz Alumni қауымдастығының мүшесі бол!
              </p>
              <p className="text-3xl tracking-wide font-normal leading-relaxed animate-fadeInUp delay-300">
      ...
      <footer className="text-white text-center bg-[url('/images/footer.jpg')] bg-center bg-no-repeat w-full bg-cover relative  px-12 py-8 ">
          ...
          <div className="relative z-10 flex flex-row items-center justify-between text-center text-whitegap-10">
            ...
            <div className="text-left w-max">
              <p className="text-2xl font-semibold mb-4 animate-fadeInUp delay-200">
                БАЙЛАНЫС АҚПАРАТЫ
              </p>
              <p className="text-lg font-light animate-fadeInUp delay-300">
