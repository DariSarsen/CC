...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 w-64 bg-red-900 rounded-r-3xl bg-opacity-40 backdrop-blur-sm text-white z-40 transform transition-transform duration-300 ease-in-out 
        ${isOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 md:static md:block`}>
        <div className="h-full flex flex-col overflow-y-auto">
          
          <div className=" p-4 text-2xl font-bold border-b border-red-300 shrink-0">
          ...
          <ul className="mt-6 space-y-4 px-6 grow">
