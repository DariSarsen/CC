  ...
  return (
    <div className="max-w-5xl mx-auto px-6 text-white mb-36">
      ...
      <div className=" mb-6 flex flex-row flex-wrap gap-4 justify-between">
        <div className="flex flex-col">
          <h1 className="text-3xl font-bold capitalize">
            {(showMyVacancies && hasRole(["company"])) ? "Мои Вакансии" : "Вакансии"}
          </h1>
        ...
        {hasRole(["company"]) && (
          <div className="flex place-items-center gap-4 flex-wrap">
            ...
            <button
              ...
              className="px-5 py-2 rounded-lg border border-red-300 bg-red-800 bg-opacity-30 hover:bg-opacity-60 transform transition duration-300"
            >
      ...
      <div className="mb-8 relative w-full">
        <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-red-200 text-2xl z-10">
          <IoIosSearch />
        </span>
        <input
          type="text"
      ...
      {isLoading ? (
        ...
        <p className="text-center text-red-200">Вакансии не найдены</p>
      ) : (
          ...
          {filteredVacancies.map((vacancy) => (
            ...
            >
              <Link
                ...
                className="text-2xl font-semibold text-red-100 hover:underline"
              >
                {vacancy.title}
              </Link>
              ...
              <p className="text-red-100 mt-2 line-clamp-3">
                {vacancy.description}
              </p>
              ...
              <div className="mt-4 flex gap-4 flex-wrap justify-end">
                ...
                {hasRole(["student"]) && (
                  ...
                  <button
                    className="px-4 py-2 rounded-lg bg-white bg-opacity-20 hover:bg-opacity-40 transition-all duration-300  border border-white border-opacity-20"
                    onClick={() => {
